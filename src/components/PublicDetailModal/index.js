...
export default class DetailModal extends React.Component {
  ...
  render() {
    ...
    if (modalWidth >= 656 + 367) {
      // fileDetailContentLeft最大宽度为656, 如果说还大于加上评论的宽度, 那么就是正常的
    ...
    return (
      <CustormModal
        ...
        overInner={
          <DetailDom {...this.props} showActiveStyles={showActiveStyles} />
        }
      />
    )
  }
...
function mapStateToProps({
  technological: {
    datas: { siderRightCollapsed, page_load_type }
  }
}) {
