        ...
        dataSource.reduce((r, c, i) => {
          return [
            ...
            <div key={`div${i}`} style={{display: 'flex', justifyContent: 'space-between', textAlign: 'left', borderBottom: '1px solid #CCC'}}>
              ...
              <div style={{width: '94px', display: 'flex', justifyContent: 'flex-end', alignItems: 'center'}}>
                {c.name===map_name?<Button icon="setting" onClick={functionalManagementOfInvestmentMap}/>:<Button icon="setting" hidden/>}
