  ...
  renderOperatorBar = () => {
    ...
    const operatorList = [
      ...
      },
      {
        ...
        icon: isShowAllCircleReview ? (
          <span>&#xe699;</span>
        ) : (
          <span>&#xe698;</span>
        ),
        toolTipText: isShowAllCircleReview
          ? '显示当前版本圈评'
          : '显示所有版本圈评',
                ...
                >
                  ...
                  isShow_textArea == true ? (
                    <span style={{ display: 'flex' }}>
                      {i.icon}&nbsp;&nbsp;
                      <span style={{ fontSize: '14px', width: '56px' }}>
                        添加圈点
                      </span>
                    </span>
                  ) : (
            ...
            >
              ...
              >
                ...
                >
                  <span style={{ display: 'flex' }}>
                    {i.icon}&nbsp;&nbsp;
                    <span style={{ fontSize: '14px' }}>退出圈点</span>
                  </span>
                </div>
              </div>
            </Tooltip>
          ))}
        {!isCommentMode && <div className={styles.commentMode_line}>|</div>}
      </div>
    )
  }
