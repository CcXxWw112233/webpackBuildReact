...
import { Input, Checkbox, Select, Button, message } from 'antd'
          ...
          <div className={indexStyles.EditFormThreeOneOut_form_right}>
            ...
            <div className={indexStyles.EditFormThreeOneOutItem}>
              ...
              <Button
                ...
                onClick={this.setShowModalVisibile.bind(this)}
              >
                编辑选项
              </Button>
            </div>
            <div className={indexStyles.EditFormThreeOneOutItem}>
              ...
              <Select
                value={
                  verification_rule === 'multiple'
                    ? default_value.split(',').filter(d => d)
                    : default_value
                }
                style={{ width: 88 }}
                size={'small'}
                mode={verification_rule === 'multiple' ? 'multiple' : ''}
                maxTagCount={0}
