...
@connect(
  ({
    projectDetail: {
      datas: { projectDynamicsList = [], p_next_id, projectDetailInfoData = {} }
    },
    technological: {
...
export default class DynamicContain extends Component {
  ...
  componentDidMount() {
    ...
    this.props.getDispatchDynamicList &&
  ...
  processItemClick = async (board_id, flow_instance_id) => {
    ...
    await this.props.dispatch({
      type: 'projectDetailProcess/updateDatas',
      payload: {
        processDetailModalVisible: !this.props.model.datas
  ...
  render() {
      ...
      switch (activity_type) {
        ...
        case 'board.create': // 创建项目
          ...
          messageContain = (
            <div
              style={{ maxWidth: 500 }}
              className={DrawDetailInfoStyle.news_text}
            >
              <div>
                <span className={DrawDetailInfoStyle.news_name}>
                  {messageValue.creator.name}
                </span>{' '}
                创建{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」
                {currentNounPlanFilterName(PROJECTS)}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
            </div>
          )
          break
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                」为「{jumpToBoard}」{currentNounPlanFilterName(PROJECTS)}名称。
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                归档了「{jumpToBoard}」{currentNounPlanFilterName(PROJECTS)}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                退出了「{jumpToBoard}」{currentNounPlanFilterName(PROJECTS)}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
            ...
            >
              <div>
                ...
                在流程「
                {
                  ...
                  >
                    {messageValue.content &&
                      messageValue.content.flowInstance &&
                      messageValue.content.flowInstance.name}
                  </span>
                }
                」中 {messageValue.title}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                删除了「{jumpToBoard}」{currentNounPlanFilterName(PROJECTS)}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                新增了关联内容「{messageValue.content.link_name}」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                移除了关联内容「{messageValue.content.link_name}」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                修改了关联内容「{messageValue.content.link_name}」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
        ...
        case 'board.card.create': // 创建任务
          messageContain = (
            ...
            >
              ...
              创建了{currentNounPlanFilterName(TASKS)}「{jumpToTask}」
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
            </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                归档了{currentNounPlanFilterName(TASKS)}「{jumpToTask}」{' '}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                完成了{currentNounPlanFilterName(TASKS)}「{jumpToBoard}」{' '}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                取消完成{currentNounPlanFilterName(TASKS)}「{jumpToBoard}」{' '}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                删除了{currentNounPlanFilterName(TASKS)}「{jumpToTask}」{' '}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                修改卡片名称为{currentNounPlanFilterName(TASKS)}「{jumpToTask}」{' '}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                修改了「{jumpToTask}」{currentNounPlanFilterName(TASKS)}
                的开始时间
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                修改了{currentNounPlanFilterName(TASKS)}描述「{jumpToTask}」{' '}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                把{currentNounPlanFilterName(TASKS)}「{jumpToTask}」指派给「
                <span className={DrawDetailInfoStyle.news_name}>
                  {messageValue.content.rela_data &&
                    messageValue.content.rela_data.name}
                </span>
            ...
            messageContain = (
              ...
              >
                <div>
                  ...
                  添加了{currentNounPlanFilterName(TASKS)}「{jumpToTask}
                  」标签为「
                  <span className={DrawDetailInfoStyle.news_name}>
                    {messageValue.content.rela_data.name}
                  </span>
            ...
            messageContain = (
              ...
              >
                <div>
                  ...
                  」中删除了标签「
                  <sapn className={DrawDetailInfoStyle.news_name}>
                    {messageValue.content.rela_data.name}
                  </sapn>
                  」
                </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                完成了子{currentNounPlanFilterName(TASKS)}「{jumpToTask}」{' '}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                取消完成子{currentNounPlanFilterName(TASKS)}「{jumpToTask}」{' '}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}
                」中创建了分组「
                <span className={DrawDetailInfoStyle.news_name}>
        ...
        case 'board.flow.instance.initiate': // 启动流程
          ...
          messageContain = (
            ...
            >
              <div>
                {messageValue.creator.name} 启动了一个
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                将「{messageValue.content.rela_users}」移出了「{jumpToBoard}」
                {currentNounPlanFilterName(PROJECTS)}
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                撤回{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」节点「
                {messageValue.content.flow_node_instance.name}」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                驳回{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」节点「
                {messageValue.content.flow_node_instance.name}」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」节点「
                {
                  messageValue.content.flow_node_instance.name
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」
                中完成了任务「{messageValue.content.flow_node_instance.name}」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」中
                中止了流程
              </div>
              {/* 「{messageValue.content.flow_node_instance.name}」 */}
              <div className={DrawDetailInfoStyle.news_time}>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}
                」中上传了一个{currentNounPlanFilterName(FILES)}「{jumpToFile}」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                更新了{currentNounPlanFilterName(FILES)}「{jumpToFile}」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                移动{currentNounPlanFilterName(FILES)}「{jumpToFile}」到回收站
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
              ...
              <div>
                ...
                {currentNounPlanFilterName(FILES)}「
                {
                  <Tooltip>
                    <span
                      style={{ color: '#1890FF' }}
                      className={DrawDetailInfoStyle.fileName}
                    >
                      {showList}
                    </span>
                  </Tooltip>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                修改了原里程碑名「
                <span className={DrawDetailInfoStyle.news_name}>
                  {messageValue.content.milestone.old_name}
                </span>
                」为「{jumpToMilestone}」里程碑名称
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
                {timestampToTime(messageValue.created)}
              </div>
          ...
          messageContain = (
            ...
            >
              <div>
                ...
                添加了里程碑「{jumpToMilestone}」负责人为「
                <span className={DrawDetailInfoStyle.news_name}>
                  {messageValue.content.rela_user &&
                    messageValue.content.rela_user.name}
                </span>
                」
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
          ...
          messageContain = (
            ...
            >
              ...
              <div>
                ...
                发表了一条里程碑「
                <span style={{ color: '#1890FF', display: 'inline-block' }}>
                  {messageValue.content.rela_content &&
                    messageValue.content.rela_content.name}
                </span>
                」的评论
              </div>
              <div className={DrawDetailInfoStyle.news_time}>
          ...
          <div className={DrawDetailInfoStyle.left}>
            {avatar ? (
              ...
              >
                <Icon
                  type={'user'}
                  style={{ fontSize: 20, color: '#8c8c8c', marginTop: 5 }}
                />
              </div>
            )}
          </div>
    ...
    return (
      <>
        <ul>
          {projectDynamicsList && projectDynamicsList.length ? (
            projectDynamicsList.map((item, childrenKey) => {
              const { rela_type } = item
              return (
                <li style={{ marginBottom: '8' }} key={childrenKey}>
                  {filterNewsType(rela_type, item, childrenKey)}
                </li>
              )
            })
          ) : (
