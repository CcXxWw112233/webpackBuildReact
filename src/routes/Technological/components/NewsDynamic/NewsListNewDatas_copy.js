    ...
    const filterTitleContain = (activity_type, messageValue) => {
      ...
      switch (activity_type) {
        ...
        case 'createBoard':
          ...
          messageContain = (
            <div>
              {messageValue.user_name} 创建{currentNounPlanFilterName(PROJECTS)}
              「
        ...
        case 'createCard':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 创建了
                {currentNounPlanFilterName(TASKS)}「{messageValue.card_name}」。
              </div>
        ...
        case 'updCard':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 更新了
                {currentNounPlanFilterName(TASKS)}信息「{messageValue.card_name}
                」。
              </div>
              <div className={NewsListStyle.news_3_time}>
                {timestampToHM(messageValue.map.create_time)}
        ...
        case 'addCardUser':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 把{currentNounPlanFilterName(TASKS)}「
                {messageValue.card_name}」执行人指派给{' '}
                {messageValue.map.full_name}。
              </div>
              <div className={NewsListStyle.news_3_time}>
                {timestampToHM(messageValue.map.create_time)}
              </div>
        ...
        case 'startWorkflow':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 启动{currentNounPlanFilterName(FLOWS)}
        ...
        case 'recallWorkflowTask':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 撤回{currentNounPlanFilterName(FLOWS)}
        ...
        case 'reassignAssignee':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 在{currentNounPlanFilterName(FLOWS)}「
                {messageValue.flow_instance_name}」节点「
        ...
        case 'uploadFile':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 上传了
                {currentNounPlanFilterName(FILES)}「{messageValue.file_name}」。
              </div>
              <div className={NewsListStyle.news_3_time}>
                {timestampToHM(messageValue.map.create_time)}
              </div>
        ...
        case 'removeFile':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 移动{currentNounPlanFilterName(FILES)}
                「{messageValue.file_name}」到回收站。
              </div>
              <div className={NewsListStyle.news_3_time}>
                {timestampToHM(messageValue.map.create_time)}
              </div>
        ...
        case 'removeFileToOtherFolder':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 移动{currentNounPlanFilterName(FILES)}
                「{messageValue.file_name}」到文件夹「{messageValue.folder_name}
                」。
              </div>
              <div className={NewsListStyle.news_3_time}>
                {timestampToHM(messageValue.map.create_time)}
        ...
        case 'copyFileToOtherFolder':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.user_name} 复制{currentNounPlanFilterName(FILES)}
                「{messageValue.file_name}」到文件夹「{messageValue.folder_name}
                」。
              </div>
              <div className={NewsListStyle.news_3_time}>
            ...
            {value.map((val, key) => {
              ...
              return (
                <div className={NewsListStyle.news_1} key={key}>
                  {filterTitleContain(activity_type, val).messageContain}
                </div>
              )
            })}
          </div>
