...
export default class index extends Component {
  ...
  onScroll = () => {
    ...
    if (
      !(
        (!hotFlag && !highRiseFlag && !authorityFlag && !dataBaseFlag) ||
        !areaFlag
      )
    ) {
      return
    ...
    const scrollTop =
      this.refs &&
      this.refs.xczContentWrapper &&
      this.refs.xczContentWrapper.scrollTop &&
      this.refs.xczContentWrapper.scrollTop
    ...
    const scrollHeight =
      this.refs &&
      this.refs.xczContentWrapper &&
      this.refs.xczContentWrapper.scrollHeight &&
      this.refs.xczContentWrapper.scrollHeight
    ...
    const windowHeight =
      this.refs &&
      this.refs.xczContentWrapper &&
      this.refs.xczContentWrapper.clientHeight &&
      this.refs.xczContentWrapper.clientHeight
  ...
  render() {
    ...
    return (
      <div className={indexStyles.xczNewContainer}>
        ...
        selectOrganizationVisible === false &&
        isRegulations === 'yes' &&
        XczNewsOrganizationList.length > 1 ? (
          <div
            className={indexStyles.boardSelectWapper}
          ...
          >
            ...
            <div className={indexStyles.boardItemWapper}>
              {XczNewsOrganizationList &&
                XczNewsOrganizationList.map((value, key) => {
                  return (
                    <div
                      key={key}
                      className={indexStyles.boardItem}
                      onClick={e => this.seeXczNews(value)}
                    >
                      <i
          ...
          >
            ...
            >
              <Switch>
                ...
                {/* 重定向 */}
                <Redirect
                  from="/technological/simplemode/workbench/xczNews"
                  to="/technological/simplemode/workbench/xczNews/hot"
                />
              </Switch>
            </div>
          </div>
