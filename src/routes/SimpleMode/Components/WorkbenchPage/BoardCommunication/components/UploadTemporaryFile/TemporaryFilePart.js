        ...
        return (
            <div className={indexStyles.temporaryFilePart}>
                        ...
                        (
                            <div className={indexStyles.operation}>
                                <span onClick={()=>this.props.transferToProject()}>
                                    <span className={globalStyles.authTheme} >&#xe6dd;</span> 转存到项目
                                </span>
                                <span onClick={()=>this.props.deleteProject()}>
                                    <span className={globalStyles.authTheme} style={{paddingLeft: '26px'}}>&#xe7c3;</span> 删除
                                </span>
                            </div>
                        ):
                        (
                ...
                <div className={indexStyles.temporaryList}>
                    {
                        temporaryData && temporaryData.map((item)=>{
                            return (
                                <div
                                    key={item.id}
                                    className={indexStyles.itemList}
                                >
                                    <div className={`${globalStyles.authTheme} ${indexStyles.fileIcon}`}>
                                        &#xe6b4;
                                    </div>
